...
This plot visualizes the trend of child deaths per unit of healthcare spending across different global regions from 2000 to 2022. It shows a general decline in child mortality relative to spending, suggesting that increased investment in healthcare is associated with improved child health outcomes. This aligns with the research question by highlighting the potential impact of government healthcare spending on public health indicators—such as vaccination coverage—which are critical in reducing preventable child deaths. The regional breakdown also supports comparative analysis across income levels, reinforcing the study’s focus on low-, middle-, and high-income countries.
...
### Interpetation and Relevance
This plot illustrates the cost-efficiency of vaccination coverage over time by showing the dollar amount spent per coverage point across six global regions from 2000 to 2022. A lower value on the y-axis indicates more efficient spending—achieving higher vaccination coverage with less financial input. This directly supports the research question by providing insight into how government healthcare spending translates into vaccination outcomes. By comparing trends across regions with varying income levels, the plot helps assess whether increased spending consistently leads to better vaccination coverage, and how efficiently different regions convert spending into immunization success.
